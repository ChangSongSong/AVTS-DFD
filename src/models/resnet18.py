...
class ResNet18(nn.Module):
    def __init__(self, block=BasicBlock, in_channels=3, layers=[2, 2, 2, 2], num_filters=[64, 128, 256, 512], strides=[2, 2, 2, 2], relu_type="relu", gamma_zero=False, avg_pool_downsample=False):
